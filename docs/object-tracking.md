...
[Content to be added: Description of different tracking scenarios in the dataset]
...
[Content to be added: Statistics about tracks in the dataset]

| Metric                        | Value         |
| ----------------------------- | ------------- |
| Total Tracks                  | [To be added] |
| Average Track Length          | [To be added] |
| Longest Track                 | [To be added] |
| Shortest Track                | [To be added] |
| Tracks with Occlusion         | [To be added] |
| Tracks with Re-identification | [To be added] |

### Track Length Distribution

[Content to be added: Distribution of track lengths]

### Object Category Distribution

[Content to be added: Distribution of tracked object categories]

| Category | Number of Tracks | Average Length |
| -------- | ---------------- | -------------- |
| Ships    | [To be added]    | [To be added]  |
| Boats    | [To be added]    | [To be added]  |
| Buoys    | [To be added]    | [To be added]  |
| ...      | ...              | ...            |
